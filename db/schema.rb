...
ActiveRecord::Schema.define(version: 20150423120739) do
  ...
  add_index "sessions", ["presentation_id"], name: "index_sessions_on_presentation_id", using: :btree
  ...
  add_foreign_key "sessions", "presentations"
